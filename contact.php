        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span> Rup Paul</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: 22kcsbcah1@keical.edu.in<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook:<br>
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 8250452496
                    </p>
                </div>
                <div class="col-md-6">
                    <form>
