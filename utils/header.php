    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Be Our Guest Events</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're planning a cocktail party, corporate gathering, celebratory event, conference, business meeting, wedding, or private dining experience, our dedicated Be Our Guest Event is here to craft a bespoke package tailored to your every need.
                </p>
                <p id="dateAndTime"></p>
            </div>
        </div>
